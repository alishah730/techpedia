...
public class UserManagementRestServiceHelper {
	...
	private static TechPediaLogger log = TechPediaLogger.getLogger(UserManagementRestServiceHelper.class.getName());
	...
	public static String createProfile(UserProfileDO userprofileDO) throws UserManagementServiceException{
		...
		try {
			...
			throw new UserManagementServiceException(e.getExceptionCode(),e.getExceptionMessage(),e.getExceptionDetails());
	...
	public static String updateProfile(UserProfileDO userprofileDO) throws UserManagementServiceException{
	...
	public static String deactivateProfile(String userID) throws UserManagementServiceException{
	...
	public static String getUserDetails(String registerID) throws UserManagementServiceException{
		log.debug("UserManagementRestServiceHelper getUserDetails : Start");
		UserProfileDO userprofileDO= null;
		response = new UMServiceResponse();
		try {
			userprofileDO = getUserManagementDAO().getUserProfile(new Long(registerID));
	...
	public static String signIn(String userID, String password) throws UserManagementServiceException {
	...
	public static String authenticate(String userID, String password) throws UserManagementServiceException {
	...
	public static String passwordReset(String userid, String oldpwd,
		...
		response = new UMServiceResponse();
		try {
			boolean val = getUserManagementDAO().passwordReset(userid,oldpwd,newpwd);
	...
	public static String updatePhoto(UpdateUserPhotoDO updateUserPhotoDO) throws UserManagementServiceException {
	...
	public static String activateProfile(String userID) throws UserManagementServiceException{
	...
	public static String emailVerification(String email) throws UserManagementServiceException{
	...
	public static String getUserTeamList(String registerID) throws UserManagementServiceException {
		log.debug("UserManagementRestServiceHelper getUserTeamList : Start");
		
		try {
			List<UserTeamListDO> userTeamList = getUserManagementDAO().getUserTeamList(new Long(registerID));
	...
	/*public static String searchUserProfiles(ProfileSearchCriteriaDO searchCriteriaDO) throws UserManagementServiceException{

		log.debug("UserManagementRestServiceHelper searchUserProfiles : Start");
		response = new UMServiceResponse();
		try {
			boolean val =  getUserManagementDAO().searchUserProfiles(searchCriteriaDO);
			if(val == true){
				gson = new Gson();
				response.setStatus(UserManagementServiceConstant.SUCCESS);
				response.setDescription(UserManagementServiceConstant.PROFILE_ACTIVATE_SUCCESS);
	...
	public static String getUserRolePermissions(String registerID) throws UserManagementServiceException {
		log.debug("UserManagementRestServiceHelper getUserRolePermissions : Start");

		try {
			UsrAccessDetails usrAccessDetails = getUserManagementDAO().getUserRolePermissions(new Long(registerID));
	...
	public static String getUserRecentComments(String registerID) throws UserManagementServiceException {
		log.debug("UserManagementRestServiceHelper getUserRecentComments : Start");

		try {
			List<UserRecentComments> userRecentComments = getUserManagementDAO().getUserRecentComments(new Long(registerID));
	...
	public static String searchUserProfiles(SearchCriteriaDO searchCriteriaDO) throws UserManagementServiceException {
		log.debug("UserManagementRestServiceHelper searchUserProfiles : Start");

		try {
			List<UserProfileDO> userProfiles = getUserManagementDAO().searchUserProfiles(searchCriteriaDO);
	...
	public static String getPopularMentorList() throws UserManagementServiceException {
		log.debug("UserManagementRestServiceHelper getPopularMentorList : Start");
		try {
			List<PopularMentorsDO> popularMentors = getUserManagementDAO().getPopularMentorList();
	...
	public static String forgotPassword(String email) throws UserManagementServiceException {
		log.debug("UserManagementRestServiceHelper forgotPassword : Start");
		
		try {
			String currentPassword = getUserManagementDAO().forgotPassword(email);
	...
	public static String searchForMentors(String projId) throws UserManagementServiceException {
		log.debug("UserManagementRestServiceHelper searchForMentors : Start");

		try {
			List<SearchForMentorListDO> mentorsList = getUserManagementDAO().searchForMentors(new Long(projId));
	...
	public static String mentorsOfProject(String projId) throws UserManagementServiceException 
	{
		log.debug("UserManagementRestServiceHelper mentorsOfProject : Start");
		
		try {
			List <Mentor1n2Details> mentorDetails = getUserManagementDAO().getMentorsOfProject(new Long(projId));
