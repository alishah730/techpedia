 ...
 *
 */
public class ReviewRatingException extends Exception{
	...
	public ReviewRatingException()
	    ...
	    public ReviewRatingException(String msg)
	    {
	        super(msg);
	    }
		 ...
		 */
		public ReviewRatingException(String exceptionCode,
		...
		public String toString() {
			return "ReviewRatingException [exceptionCode=" + exceptionCode
