...
public class GetAllGytiProjectException extends Exception {
	 ...
	 */
	public GetAllGytiProjectException(String exceptionCode,
	 ...
	 * @param message
	 */
	public GetAllGytiProjectException(String message) {
		super(message);		
	}
