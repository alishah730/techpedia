 ...
 *
 */
public class SuggestReviewerException extends Exception {
	 ...
	 */
	public SuggestReviewerException(String exceptionMessage, String exceptionDetails) {
		this.exceptionMessage = exceptionMessage;
		this.exceptionDetails = exceptionDetails;
	}
	/**
	 * @param message
	 */
	public SuggestReviewerException(String message) {
		super(message);		
	}
