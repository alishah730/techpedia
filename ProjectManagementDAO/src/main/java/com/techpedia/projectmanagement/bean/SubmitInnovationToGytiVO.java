 ...
 *
 */
public class SubmitInnovationToGytiVO {
	...
	public String toString() {
		return "SubmitInnovationToGytiVO [projId=" + projId + ", projTypeId="
				+ projTypeId + ", projTitle=" + projTitle + ", projBranches="
				+ projBranches + ", projKeywords=" + projKeywords
				+ ", projTeamMembers=" + projTeamMembers + ", projBranchList="
				+ projBranchList + ", projTeamMemberList=" + projTeamMemberList
				...
				+ ", projEstimationCost=" + projEstimationCost + ", imgName="
				+ imgName + ", imgByteArray=" + imgByteArray
				...
				+ projPhotoVideoNewsOthers + ", projFinishYear="
				+ projFinishYear + "]";
	}
