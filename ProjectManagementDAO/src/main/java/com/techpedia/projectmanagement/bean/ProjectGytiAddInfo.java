 ...
 * @author charan_teja
 */
public class ProjectGytiAddInfo {
private long projId;
...
private String projPreviousAwardYear;
 ...
 */
public String getProjPreviousAwardYear() {
	return projPreviousAwardYear;
}
 ...
 */
public void setProjPreviousAwardYear(String projPreviousAwardYear) {
	this.projPreviousAwardYear = projPreviousAwardYear;
}
/* (non-Javadoc)
...
public String toString() {
	return "ProjectGytiAddInfo [projId=" + projId + ", projAppliedAwards="
			+ projAppliedAwards + ", projGuideName=" + projGuideName
			+ ", projGuideEmail=" + projGuideEmail + ", projGuideMobile="
			+ projGuideMobile + ", projAcademicProgram=" + projAcademicProgram
			+ ", projStatusInfo=" + projStatusInfo + ", projCopyrightInfo="
			+ projCopyrightInfo + ", projProofInfo=" + projProofInfo
			+ ", otherDistinguishablePatents=" + otherDistinguishablePatents
			+ ", projFeature=" + projFeature + ", projFrugalityInfo="
			+ projFrugalityInfo + ", projObjectiveInfo=" + projObjectiveInfo
			+ ", projContributeInfo=" + projContributeInfo
			+ ", projImpactInfo=" + projImpactInfo + ", projRequiredResource="
			+ projRequiredResource + ", projResearchContinue="
			+ projResearchContinue + ", projPatentWork=" + projPatentWork
			+ ", projPublishedPaper=" + projPublishedPaper + ", projOtherInfo="
			+ projOtherInfo + ", projBenefitInfo=" + projBenefitInfo
			+ ", projPreviousAwardYear=" + projPreviousAwardYear
			+ ", nominatedBy=" + nominatedBy + ", publishOnWebsite="
			+ publishOnWebsite + ", projObjectiveInfoArea="
			+ projObjectiveInfoArea + ", projPhotoVideoNewsOthers="
			+ projPhotoVideoNewsOthers + ", projFinishYear=" + projFinishYear
			+ "]";
}
