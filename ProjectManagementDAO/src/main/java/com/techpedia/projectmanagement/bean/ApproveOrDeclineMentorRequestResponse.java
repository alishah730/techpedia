 ...
 *
 */
public class ApproveOrDeclineMentorRequestResponse {
	...
	/**
	 * @return the declineComments
	 */
	public String getDeclineComments() {
		return declineComments;
	}
	/**
	 * @param declineComments the declineComments to set
	 */
