...
public class ReviewerDetailsDO {
	...
	private ArrayList<Branch> revBranchList;
	/**
	...
	/**
	 * @return the revEmailId
	 */
	public String getRevEmailId() {
		return revEmailId;
	}
	/**
	 * @param revEmailId the revEmailId to set
	 */
	...
	/**
	 * @param revUsrId the revUsrId to set
	 */
	...
	/**
	 * @param revFname the revFname to set
	 */
	...
	/**
	 * @param revMname the revMname to set
	 */
	...
	/**
	 * @param revLname the revLname to set
	 */
	...
	/**
	 * @param revSex the revSex to set
	 */
	...
	/**
	 * @param revState the revState to set
	 */
	...
	/**
	 * @return the revBranchList
	 */
	public ArrayList<Branch> getRevBranchList() {
		return revBranchList;
	}
	/**
	 * @param revBranchList the revBranchList to set
	 */
	public void setRevBranchList(ArrayList<Branch> revBranchList) {
		this.revBranchList = revBranchList;
	}
