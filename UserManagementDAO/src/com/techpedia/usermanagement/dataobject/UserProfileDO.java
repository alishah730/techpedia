...
public class UserProfileDO {
	...
	public String toString() {
		return "UserProfileDO [rgstrId=" + rgstrId + ", firstName=" + firstName
				...
				+ ", email=" + email + ", address=" + address + ", addrLn1="
				+ addrLn1 + ", addrLn2=" + addrLn2 + ", city=" + city
				+ ", pincode=" + pincode + ", country=" + country + ", state="
				+ state + ", district=" + district + ", mobile=" + mobile
				+ ", homePhoneNo=" + homePhoneNo + ", photo=" + photo
