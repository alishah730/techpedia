...
public class SubmitInnovationToGyti {
		...
		private String projObjectiveInfoArea;
		private String projPhotoVideoNewsOthers;
		private String projOtherPatentWork;
		private String projIsOverProductive;
		private String projFinishYear;
		...
		@JsonIgnore
		/**
		 * @return the projTeamMembersString
		 */
		public String getProjTeamMembersString() {
			return projTeamMembersString;
		}
		/**
		 * @param projTeamMembersString the projTeamMembersString to set
		 */
		...
		@JsonIgnore
		/**
		 * @return the projBranchesString
		 */
		public String getProjBranchesString() {
			return projBranchesString;
		}
		/**
		 * @param projBranchesString the projBranchesString to set
		 */
		...
		@JsonIgnore
		/**
		 * @return the projKeywordsString
		 */
		public String getProjKeywordsString() {
			return projKeywordsString;
		}
		/**
		 * @param projKeywordsString the projKeywordsString to set
		 */
		...
		/**
		 * @param nominatedBy the nominatedBy to set
		 */
		public void setNominatedBy(String nominatedBy) {
			this.nominatedBy = nominatedBy;
		}
		/**
		 * @return the publishOnWebsite
		 */
		public String getPublishOnWebsite() {
			return publishOnWebsite;
		}
		/**
		 * @param publishOnWebsite the publishOnWebsite to set
		 */
		public void setPublishOnWebsite(String publishOnWebsite) {
			this.publishOnWebsite = publishOnWebsite;
		}
		/**
		 * @return the projObjectiveInfoArea
		 */
		public String getProjObjectiveInfoArea() {
			return projObjectiveInfoArea;
		}
		/**
		 * @param projObjectiveInfoArea the projObjectiveInfoArea to set
		 */
		public void setProjObjectiveInfoArea(String projObjectiveInfoArea) {
			this.projObjectiveInfoArea = projObjectiveInfoArea;
		}
		/**
		 * @return the projPhotoVideoNewsOthers
		 */
		public String getProjPhotoVideoNewsOthers() {
			return projPhotoVideoNewsOthers;
		}
		/**
		 * @param projPhotoVideoNewsOthers the projPhotoVideoNewsOthers to set
		 */
		public void setProjPhotoVideoNewsOthers(String projPhotoVideoNewsOthers) {
			this.projPhotoVideoNewsOthers = projPhotoVideoNewsOthers;
		}
		/**
		 * @return the projOtherPatentWork
		 */
		public String getProjOtherPatentWork() {
			return projOtherPatentWork;
		}
		/**
		 * @param projOtherPatentWork the projOtherPatentWork to set
		 */
		public void setProjOtherPatentWork(String projOtherPatentWork) {
			this.projOtherPatentWork = projOtherPatentWork;
		}
		/**
		 * @return the projIsOverProductive
		 */
		public String getProjIsOverProductive() {
			return projIsOverProductive;
		}
		/**
		 * @param projIsOverProductive the projIsOverProductive to set
		 */
		public void setProjIsOverProductive(String projIsOverProductive) {
			this.projIsOverProductive = projIsOverProductive;
		}
		/**
		 * @return the projFinishYear
		 */
		public String getProjFinishYear() {
			return projFinishYear;
		}
		/**
		 * @param projFinishYear the projFinishYear to set
		 */
		public void setProjFinishYear(String projFinishYear) {
			this.projFinishYear = projFinishYear;
		}
		/* (non-Javadoc)
		...
		public String toString() {
			return "SubmitInnovationToGyti [projId=" + projId + ", projTypeId="
					+ projTypeId + ", projTitle=" + projTitle
					...
					+ ", projFacRgstrId=" + projFacRgstrId
					+ ", projEstimationCost=" + projEstimationCost
					+ ", imgName=" + imgName + ", imgByteArray=" + imgByteArray
					+ ", footerImgName=" + footerImgName
					+ ", footerImgByteArray=" + footerImgByteArray
					+ ", photo1Path=" + photo1Path + ", photo2Path="
					+ photo2Path + ", projBranchList=" + projBranchList
					+ ", projTeamMemberList=" + projTeamMemberList
					+ ", projMentor1Id=" + projMentor1Id + ", projMentor2Id="
					+ projMentor2Id + ", projGuideId=" + projGuideId
					+ ", projToFloat=" + projToFloat + ", projCommentsPublish="
					+ projCommentsPublish + ", projGrade=" + projGrade
					+ ", projTeamLeaderId=" + projTeamLeaderId
					+ ", projAppliedAwards=" + projAppliedAwards
					...
					+ ", projStatusInfo=" + projStatusInfo
					+ ", projCopyrightInfo=" + projCopyrightInfo
					+ ", projProofInfo=" + projProofInfo
					+ ", otherDistinguishablePatents="
					+ otherDistinguishablePatents + ", projFeature="
					+ projFeature + ", projFrugalityInfo=" + projFrugalityInfo
					...
					+ ", nominatedBy=" + nominatedBy + ", publishOnWebsite=" + publishOnWebsite
					+ ", projObjectiveInfoArea=" + projObjectiveInfoArea + ", projPhotoVideoNewsOthers="
					+ projPhotoVideoNewsOthers + ", projOtherPatentWork=" + projOtherPatentWork + ", projIsOverProductive="
					+ projIsOverProductive + ", projFinishYear=" + projFinishYear +  "]";
		}
