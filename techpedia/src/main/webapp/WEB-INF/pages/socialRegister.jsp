...
<div class="container customFont borderRadius style">
	<div class="page-container">
		...
		<div class="page-content-wrapper"
			ng-controller="SocialRegisterController" ng-init="InitLoad()">
												...
												<div class="col-xs-12">
													<div class="input-group input-group-sm">
														<span class="input-group-addon"
															...
															type="email" id="email" maxlength=100
												...
												<div class="col-xs-12">
													<div class="input-group input-group-sm">
														<span class="input-group-addon"
															...
															type="password" id="userPassword1" class="form-control"
															placeholder="Password" ng-model="register.password"
															required style="width: 375px !important;"
        ...
        Fields are not equal!</div> -->
											...
											<div class="panel-body photoRTC">
												...
												<div class="col-xs-12">
													<div class="col-xs-3">
														...
														<img id="profilePic" src="images/gravatar.png" width=160
															height=130 src="" class='photo' alt='photo'>
													</div>
													...
													<div class="col-xs-9">
														...
														<button class='btn btn-sm btn-info'
															...
															style="background-color: #5cb85c;float: right;">Upload photo</button>
									...
									<div class="col-xs-12 col-md-6">
										...
										<div class="panel panel-default" style="border-style: none; background-color: #f5f5f5">
											...
											<div class="panel-body user-info" style="border-style: none; background-color: #f5f5f5;">

												<div class="col-xs-12">
													<div class="input-group input-group-sm">
														<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Type *</span> <select
															style="width: 300px !important;" id="type" name="type"
															class="form-control" ng-model="register.userType"
															required>
												...
												<div class="col-xs-12">
													<div class="input-group input-group-sm">
														<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Username *</span> <input
															style="width: 300px !important;" name="userName" type="text" id="userName"
															class="form-control" placeholder="Username"
															ng-model="register.userName" required ng-maxlength="50"
															data-toggle='tooltip' data-placement='right'
												...
												<div class="col-xs-12">
													<div class="input-group input-group-sm ">
														<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;"> First name *</span> <input
															style="width: 300px !important;" name="firstName" type="text" id="firstName"
     ...
     <p ng-show="registerBasicForm.firstName.$invalid && !registerBasicForm.firstName.$pristine"  data-toggle="tooltip" data-original-title="Default tooltip">  -->
												...
												<div class="col-xs-12">
													<div class="input-group input-group-sm">
														<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Middle name </span> <input
															style="width: 300px !important;" name="midName" type="text" class="form-control rname"
												...
												<div class="col-xs-12">
													<div class="input-group input-group-sm">
														<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Last name</span> <input
															style="width: 300px !important;" name="lastName" type="text" id="lastName"
															class="form-control rname" placeholder="Last name"
															ng-model="register.lastName"  ng-maxlength="50"
													...
													<div class="input-group input-group-sm">
														...
														<div class="form-group" style="margin-left: 10px;">
																...
																<label class="radio-inline"> <input type="radio"
																	name="genderMale" id="gender" value="male" ng-model="register.gender" required>Male
																</label> <label class="radio-inline"> <input
																	type="radio" name="genderFemale" id="gender" ng-model="register.gender"  value="female">Female
																</label>
																<label class="radio-inline"> <input
																	type="radio" name="genderTrans" id="gender" ng-model="register.gender"  value="trans">Trans
																</label>
												...
												<div class="input-group input-group-sm">
													...
													<input name="age" type="text" id="age" style="width: 300px"
														...
														ng-model="register.age" ng-value="personAge"
											...
											<div class="col-xs-12">&nbsp;</div>
												...
												<div class="col-xs-12">
													<div class="input-group input-group-sm">
														<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Landline</span> <input
															style="width: 300px !important;" name="homePhoneNo" type="text" class="form-control"
												...
												<div class="col-xs-12">
													...
													<div class="input-group input-group-sm">
														<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Mobile</span> <input
															style="width: 300px !important;" name="mobile" type="text" id="mobile"
															class="form-control" placeholder="Mobile"
															ng-model="register.mobile"  ng-minlength=10
									...
									<div class="col-xs-12 col-md-6">
										<div class="panel panel-default"  style="border-style: none; background-color: #f5f5f5">
											...
											<div class="panel-body personal-info" style="border-style: none; background-color: #f5f5f5;">
												...
												<div class="col-xs-12">
													...
													<div class="input-group input-group-sm">
														...
														<div class="form-group">
															...
															<div class="col-sm-8">
																<label class="radio-inline"> <input type="radio"
																	name="mobileYesNo" id="mobileYesNo" value="Y" ng-model="register.isMobile">Yes
																</label> <label class="radio-inline"> <input
																	type="radio" name="mobileYesNo" id="mobileYesNo" ng-model="register.isMobile" ng-checked="true" value="N">No
																</label>
															</div>
														</div>
													</div>
												...
												<div class="col-xs-12">
													<div class="input-group input-group-sm">
														<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Address *</span> <input
															name="addrLn1" type="text" id="addrLn1"
												...
												<div class="col-xs-12">
													<div class="input-group input-group-sm">
														<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">District *</span> <input
															style="width: 300px !important;" name="district"
												...
												<div class="col-xs-12">
													<div class="input-group input-group-sm">
														<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Country *</span> <input
															style="width: 300px !important;" name="country"
												...
												<div class="col-xs-12">
													<div class="input-group input-group-sm">
														<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">State *</span>
													 ...
													 -->
														...
														<input style="width: 300px !important;" name="state" type="text" id="state"
															class="form-control" placeholder="State"
															ng-model="register.state" required ng-maxlength="100"
															data-toggle='tooltip' data-placement='right'
												...
												<div class="col-xs-12">
													<div class="input-group input-group-sm">
														<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">City *</span>
														<!-- <select style="width: 300px !important;"  id="city" class="form-control" name="city"  ng-model="register.city" required>
													<option value selected="selected" >select</option>
													</select> -->
														<input style="width: 300px !important;" name="city" type="text" id="city"
															class="form-control" placeholder="City"
															ng-model="register.city" required ng-maxlength="100"
															data-toggle='tooltip' data-placement='right'
												...
												<div class="col-xs-12">
													<div class="input-group input-group-sm">
														<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Pincode *</span> <input
															style="width: 300px !important;" name="pincode"
...
<a href="#" class="btn btn-primary reg-ctn-1" onclick="checkEmpty()"><span
										...
										<a href="#"><input type="submit"
											class="btn btn-primary reg-ctn-1" style="margin-left: 91%; background-color: #5cb85c;" value="Continue" onclick="checkEmpty()"
											value="Continue"></a>
									</div>
								</form>
							</div>
						...
						<div>
							...
							<form id="rfegisterAdditionalStudentForm"
								...
								<div class="dynamic-div" id="student"
									...
									<div class="panel panel-default"  style="border-style: none; background-color: #f5f5f5">
										...
										<div class="panel-body" style="border-style: none; background-color: #f5f5f5;">
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Degree *</span> <input
														id="studentdegree" maxlength=100 name="degreeOfStudent"
														style="width:300px !important;" type="text" class="form-control" placeholder="Degree"
														ng-model="register.degreeOfStudent" required
														ng-maxlength="100" ng-pattern="/^(\D)+$/" required
														data-toggle='tooltip' data-placement='right'
														title="Please enter valid degree" />
														<input style="width: 188px !important;display:none;" class="form-control" required ng-model="register.degreeOfStudent" id="studentdegree1"
														 />
											...
											<!-- <div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Date of birth</span> <input
														id="dateOfBirthDatePicker" name="dob" type="text"
														class="form-control" placeholder="Date of birth(YYYY-MM-DD)"
														ng-model="register.dob" datepicker-angular required
														style="width: 300px;" required data-toggle='tooltip'
														data-placement='right' title="Please enter date of Birth" /><span
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Student ID *</span> <input
														style="width:300px !important" name="studentID" type="text" id="studentID"
														class="form-control" placeholder="Student ID"
														ng-model="register.studentID" required
														data-toggle='tooltip' data-placement='right'
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Branch *</span> <input
														style="width: 300px !important;" type="text"
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">University *</span> <input
														style="width: 300px !important;" name="university"
														type="text" id="university" class="form-control"
														placeholder="University" ng-model="register.university"
														required ng-maxlength="100" ng-pattern="/^(\D)+$/"
														data-toggle='tooltip' data-placement='right'
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">State *</span> <input
														style="width: 300px !important;" name="collegeState"
														type="text" id="collegeState" class="form-control collegeState"
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">College name *</span>
													...
													<input style="width: 300px !important;" type="text"
														class="form-control CollegeNames" placeholder="Search Colleges"
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Completion Year *</span> <input
														...
														required style="width: 300px;" required
														data-toggle='tooltip' data-placement='right'
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Facebook Id</span> <input
														style="width: 300px !important;" type="url"
									...
									<div class="panel panel-default"  style="border-style: none; background-color: #f5f5f5">
										...
										<div class="panel-body"  style="border-style: none; background-color: #f5f5f5;">
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Degree *</span> <input
														...
														<input style="width: 188px !important;display:none;" class="form-control" required ng-model="register.degreeOfFaculty" id="degreeOfFaculty1"
														 />
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Facebook Id</span> <input
														style="width: 300px !important;" type="url" class="form-control" placeholder="Facebook Id"
														ng-model="register.faceBookId" id="faceBookId" value=""
														data-toggle='tooltip' data-placement='right'
														title="Please enter Facebook Id"  http-prefixfb>
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Affiliated
														...
														style="width: 300px !important;" id="affltUniversityOfFaculty" type="text"
														class="form-control"
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Twitter Id</span> <input
														style="width: 300px !important;" type="url" class="form-control" placeholder="Twitter Id"
														ng-model="register.twitterId" id="twitterId" value=""
														data-toggle='tooltip' data-placement='right'
														title="Please enter Twitter Id" http-prefixtwit>
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">LinkedIn Id</span> <input
														style="width: 300px !important;" type="url" class="form-control" placeholder="LinkedIn Id"
														ng-model="register.LinkedinId" id="LinkedInId" value=""
														data-toggle='tooltip' data-placement='right'
														title="Please enter LinkedIn Id" http-prefixlink>
									...
									<div class="panel panel-default"  style="border-style: none; background-color: #f5f5f5">
										...
										<div class="panel-body" style="border-style: none; background-color: #f5f5f5;">
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Designation *</span> <input
														style="width: 300px !important;" name="designationOfMentor" id="designationOfMentor"
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Degree *</span> <input
														style="width: 300px !important;" name="degreeOfMentor" id="degreeOfMentor" type="text"
														class="form-control" placeholder="Degree"
														ng-model="register.degreeOfMentor" required
														ng-pattern="/^(\D)+$/" required data-toggle='tooltip'
														data-placement='right'
														title="Please enter degree of mentor" />
														<input style="width: 188px !important;display:none;" class="form-control" required ng-model="register.degreeOfMentor" id="degreeOfMentor1"
														 />
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Time spare *</span> <input
														style="width: 300px !important;" name="timeUspaceForMentoringPerMnth"
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Experience *</span> 
													<!-- <input
														style="width: 300px !important;" name="professionalExperience" id="professionalExperience"
														type="text" class="form-control"
														...
														<textarea rows="3" cols="32" name="professionalExperience"
														id="professionalExperience" placeholder="Professional experience"
														ng-model="register.professionalExperience" style="resize: none;"
														required data-toggle='tooltip' data-placement='right'
														title="Please enter proffesional experience" ng-maxlength=1000;></textarea>
													</div>
													<div class="alert alert-sm alert-danger alert-dismissible"
														role="alert"
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Interest *</span>
													 <!-- <input
														style="width: 300px !important;" name="intOnGrassrtInnovators" id="intOnGrassrtInnovators"
														type="text" class="form-control"
														...
														<textarea rows="3" cols="32" name="intOnGrassrtInnovators"
														id="intOnGrassrtInnovators" placeholder="grass root innovators interest"
														ng-model="register.intOnGrassrtInnovators" style="resize: none;"
														required data-toggle='tooltip' data-placement='right'
														title="Please enter grass root innovators interest" ng-maxlength=1000;></textarea>
												</div>
												<div class="alert alert-sm alert-danger alert-dismissible"
														role="alert"
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Commitment *</span>
													<!--  <input
														...
														<textarea rows="3" cols="32" name="commitmentUBringIn"
														id="commitmentUBringIn" placeholder="Commitment you bring"
														ng-model="register.commitmentUBringIn" style="resize: none;"
														required data-toggle='tooltip' data-placement='right'
														title="Please enter commitment you bring" ng-maxlength=1000;></textarea>
											...
											<div class="col-xs-12 col-md-6">
												<div class="input-group input-group-sm">
													<span class="input-group-addon" style="border-right: 1px solid #ccc; background-color: #217690; width: 130px; font-family: arial; color: #ffffff;">Association *</span> 
													<!-- <input
														style="width: 300px !important;" maxlength=200 name="institutionalAssctnInfo"
														id="institutionalAssctnInfo" type="text"
														class="form-control"
														...
														<textarea rows="3" cols="32" name="institutionalAssctnInfo"
														id="institutionalAssctnInfo" placeholder="Institution association info"
														ng-model="register.institutionalAssctnInfo" style="resize: none;"
														required data-toggle='tooltip' data-placement='right'
														title="Please enter Institutional Association Info" ng-maxlength=1000;></textarea>
												...
												<div class="alert alert-sm alert-danger alert-dismissible"
														...
														Institution Association Info Description cannot be more than 1000 characters</div>
											</div>
							...
							<div class="col-xs-12">
								...
								style="color: white;">Continue</span></a> -->
								<a href="#"><input type="submit"
									class="btn btn-primary reg-ctn-2" style="margin-left: 91%; background-color: #5cb85c;" value="Continue"
				...
				.each(
						function() {
							...
							if ($.trim($("#firstName").val()) === ""
									...
									|| $.trim($("#addrLn1").val()) === ""
									|| $.trim($("#district").val()) === ""
									|| $.trim($("#city").val()) === "select city"
									|| $.trim($("#state").val()) === "? undefined:undefined ?"
									|| $.trim($("#state").val()) === "select"
									|| $.trim($("#country").val()) === ""
									|| $.trim($("#pincode").val()) === ""
									|| $.trim($("#email").val()) === "") {
								empty = "isempty";
