...
<title>IE Version Not supported</title>
...
<p style="text-align: center;">User is inactive for given email id. Please activate using the link which has been sent to your mail.<p>
