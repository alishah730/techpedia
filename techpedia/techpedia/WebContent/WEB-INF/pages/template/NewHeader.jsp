...
<body>
	...
	<img src="images/art/bg7.jpg" alt="" width="2048" height="1536" /> -->
		...
		<div id="header">
			...
			<img style="width: 272px; height: 65px; " class="img-responsive"
    													...
    													<div class="item active">
    														...
    														<form class="form-horizontal" role="form" id="login-form">
    															<div class="form-group">
    																...
    																<div class="col-sm-9"><input id="emailId" name="emailId" type="text" class="input-sm form-control" id="inputEmail3" placeholder="Email" autocomplete="off"></div>
    															</div>
    															<div class="form-group">
    														...
    														<p class="text-primary" style="cursor: pointer;" data-target="#carousel-example-account" data-slide-to="2" ><small>Lost Your Password?</small></p>
    													</div>
    													<div class="item">
