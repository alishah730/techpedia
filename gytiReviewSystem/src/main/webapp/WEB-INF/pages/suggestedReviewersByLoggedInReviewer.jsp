...
<body style="background-color: #f5f5f5;">
	...
	<div  id="mainPanelBody" class="col-xs-10 col-md-10 content-wrapper"
		ng-controller="suggestedReviewersByLoggedInReviewerController"
		ng-init="InitLoad()">
		...
		<div class="" style="padding-left: 0px; padding-right: 0px;">
			...
			<div id="Reviewheader" style="background-color: #cecfd1;">
				<p
					style="font-size: 22px; color: black; text-align: justify; margin-top: 10px; margin-left: 10px;">Suggested
					Reviewers Request Status List</p>
			</div>
			...
			<div id="angularLoader" layout="row" layout-sm="column" layout-align="space-around" >
        	...
        	<div id="noInfo" style="text-align: center;">
						...
						<p>{{errorMessage}} click <a href="" ng-click="InitLoad()">here</a> to go back</p>
					</div>
			<div id="tableDataBody">
			<div id="tableDivheade" class="container" 
			...
			<!-- 	<div class="loaderBody" id="loder">Loding...</div> -->
			<div id="tableDiv table-responsive" class="col-xs-12">
				...
				<table class="table table-striped" cellspacing="0" width="100%">
					<tr style="font-weight: bold;">
						...
						<td custom-sort order="'Assign From'" sort="sort">Assign From</td>
						<td custom-sort order="'Assign To'" sort="sort">Assign To</td>
						<td custom-sort order="'Assign Date'" sort="sort">Assign Date</td>
			...
			<div class="col-xs-12">&nbsp;</div>
			<div id="tablePaging" class="col-xs-12"
